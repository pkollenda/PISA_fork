...
class TestAdmAreaGetCountryData:
    def test_get_country_data_level_0(self, mocker):
        ...
        mocker.patch("layers.GADMDownloader.get_shape_data_by_country_name", return_value=gdf)
    ...
    def test_get_country_data_level_1(self, mocker, capsys):
        # Create two simple square polygons
        polygon1 = Polygon([(0, 0), (1, 0), (1, 1), (0, 1)])
        polygon2 = Polygon([(2, 2), (3, 2), (3, 3), (2, 3)])
